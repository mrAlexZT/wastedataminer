...
_LOG_DIR_           = CONFIG._LOG_DIR_
_BOTTLENECK_DIR_    = CONFIG._BOTTLENECK_DIR_
_MODEL_DIR_         = CONFIG._MODEL_DIR_
_DATASET_           = CONFIG._DATASET_
_FLIP_LEFT_RIGHT_   = CONFIG._FLIP_LEFT_RIGHT_ 	
_RANDOM_CROP_       = CONFIG._RANDOM_CROP_ 		
_RANDOM_BRIGHNESS_  = CONFIG._RANDOM_BRIGHNESS_		
_RANDOM_SCALE_ 	    = CONFIG._RANDOM_SCALE_		
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default=_MODEL_FULL_PATH_,
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--output_labels',
      type=str,
      default=_LABELS_FULL_PATH_,
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default=_LOG_DIR_+os.sep+str(date.today()),
